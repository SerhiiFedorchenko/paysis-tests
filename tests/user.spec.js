...
describe('User', function () {
  ...
  describe('Delete', function () {
    describe('With existing user ID', function () {
      ...
      it('Response body contains succsess message', function () {
        expect(response.body.message).eql('User deleted.')
      })
    })
    ...
    describe('With non-existing user ID', function () {
      ...
      before(async function () {
        response = await userHelper.delete('blablabla')
      })
      ...
      it('Response body contains error message', function () {
        expect(response.body.message).eql('No user found.')
      })
    })
  })
})
